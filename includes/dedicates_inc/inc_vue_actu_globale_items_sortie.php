...
$viewname_it1 = 'Vue_actu_globale_items';
$view = views_get_view ($viewname_it1);
$viewdisplay_it1 = $view->set_display('block_1');
...
if (!empty($view->result)) {
  ...
  $output = '<div id="items_sortie"><h3 class="titre-pole-formation">'.$view->get_title().'</h3>' .$view->preview($viewdisplay_it1).'</div>';
