<!--______________NODE TPL POUR TdC INNOVATION CUSTOM________________ -->
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
  <div class="node-inner">
<!--______________COLONNE GAUCHE 1________________ -->
  <!-- <pre> <?php //print_r($node); ?> </pre>-->   <!-- listage des variables du $content -->
<div id="colonne-1" class="col1_layout_9_3 contenu-vdl contenu_innovation">
...
<div id="colonne-2" class="col2_layout_9_3 contenu-vdl contenu_innovation">
     <?php if ($submitted): ?>
